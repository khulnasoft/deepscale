...
class HFBertLayerPolicy(DSPolicy):
    ...
    def get_hidden_heads(self):
        return (
            self.client_module.attention.self.query.weight.data.shape[1],
    ...
    def mlp(self):
        ...
        return (
            self.linear_layer,
            intermediate_ff.weight.data,
            intermediate_ff.bias.data,
    ...
    def layerNorm(self):
        ...
        return (
            attention_layernorm.weight.data,
...
class HFGPTNEOLayerPolicy(DSPolicy):
    ...
    def get_hidden_heads(self):
        return (
            self.client_module.attn.attention.q_proj.weight.data.shape[1],
    ...
    def layerNorm(self):
        return (
            self.client_module.ln_2.weight.data,
...
class MegatronLayerPolicy(DSPolicy):
    ...
    def get_hidden_heads(self):
        return (
            self.client_module.attention.query_key_value.weight.data.shape[1],
    ...
    def layerNorm(self):
        return (
            self.client_module.post_attention_layernorm.weight.data,
