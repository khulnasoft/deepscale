...
from deepscale.model_implementations.transformers.ds_bloom import DeepScaleBloomInference
from deepscale.model_implementations.transformers.ds_gpt import DeepScaleGPTInference
from deepscale.model_implementations.transformers.ds_bert import DeepScaleBERTInference
from deepscale.model_implementations.transformers.ds_megatron_gpt import DeepScaleMegatronGPTInference
from deepscale.model_implementations.transformers.ds_opt import DeepScaleOPTInference
from deepscale.model_implementations.transformers.ds_llama2 import DeepScaleLlama2Inference
...
def load_model_with_checkpoint(r_module,
    ...
    layer_policies = {
        ...
        LinearLayer: load,
        Normalize: load,
        transformer_inference.DeepScaleTransformerInference: load_transformer_layer,
        DeepScaleBloomInference: load_transformer_layer,
        DeepScaleGPTInference: load_transformer_layer,
        DeepScaleBERTInference: load_transformer_layer,
        DeepScaleMegatronGPTInference: load_transformer_layer,
        DeepScaleOPTInference: load_transformer_layer,
        DeepScaleLlama2Inference: load_transformer_layer,
