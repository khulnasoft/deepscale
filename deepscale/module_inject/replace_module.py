...
class ReplaceWithTensorSlicing:
    ...
    def merge_assert(self, dim1, dim2):
        assert (
            dim1 > dim2
        ), "Merging tensors is not allowed here! Please use deepscale load_checkpoint\
...
def replace_transformer_layer(
    ...
    def replace_with_policy(child, policy_cls, inference=False, preln=True, layer_id=0):
        ...
        attn_linear_layer, qkvw, qkvb, dense_w, dense_b, scale_attention = (
            policy.attention()
        )
        ...
        if inference:
            transformer_config = transformer_inference.DeepScaleInferenceConfig(
            ...
            if quantize and quantize_settings is not None:
                ...
                new_module = transformer_inference.DeepScaleTransformerInference(
                    transformer_config,
                    mp_group=mp_group,
            ...
            transformer_config = deepscale.DeepScaleTransformerConfig(
            ...
            new_module = deepscale.DeepScaleTransformerLayer(transformer_config)
