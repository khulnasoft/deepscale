...
# DeepScale Team
import torch
from deepscale.utils.logging import warning_once
from deepscale.module_inject.tp_shard import get_shard_size, get_shard_size_list, get_num_kv_heads, get_n_embd, get_num_attention_heads
