...
import deepscale
from deepscale.ops.transformer.inference.config import DeepScaleInferenceConfig
...
class BaseTransformerContainer(ABC):
    ...
    def __init__(self, policy, config, model_config, layer_id, child):
        ...
        # Triton
        self.use_triton = config.use_triton and deepscale.HAS_TRITON
    ...
    def create_ds_model_config(self):
        ...
        self.ds_model_config = DeepScaleInferenceConfig(
        ...
        if self.use_triton and deepscale.HAS_TRITON:
            ...
            if not self.config.triton_autotune:
                from deepscale.ops.transformer.inference.triton.matmul_ext import fp16_matmul
