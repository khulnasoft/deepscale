...
from deepscale.utils.types import ActivationFuncType, NormType
...
class DS_LLAMA2Container(MetaTensorContainer, HybridGatedMLPContainer, HybridSplitQKVContainer,
    ...
    def create_module(self, config=None):
        ...
        self.module = DeepScaleLlama2Inference(_config, mp_group=self.mp_group)
    ...
    def get_hidden_heads(self):
        return self.client_module.attention.wq.weight.shape[1], \
                ...
                (self.client_module.feed_forward.w1.weight.shape[0] * \
                    deepscale.comm.get_world_size() if deepscale.comm.is_initialized() else 1) # this is a hack to inject when model is already partitioned!
