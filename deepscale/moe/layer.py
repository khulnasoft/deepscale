...
class MoE(torch.nn.Module):
    """
    DeepScale MOE API: This defines a simple API that can be used from client-side code.
    """
    def __init__(
        self,
        hidden_size,
        ...
        assert (
            groups.is_initialized()
        ), "Please call deepscale.utils.groups.initialize() before using MoE layers"
