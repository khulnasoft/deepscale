...
from deepscale.utils import groups, log_dist
...
class MoE(nn.Module):
    ...
    def __init__(self,
        ...
        self.deepscale_moe = MOELayer(TopKGate(hidden_size, num_experts, k, capacity_factor, eval_capacity_factor,
    ...
    def set_deepscale_parallelism(self, use_data_before_expert_parallel_: bool = False) -> None:
    ...
    def _create_process_groups(self, use_data_before_expert_parallel_: bool = False) -> None:
        ...
        # Set the group handle for the MOELayer (deepscale_moe) object
        self.deepscale_moe._set_ep_group(groups._get_expert_parallel_group(self.expert_group_name))
    ...
    def forward(self,
        ...
        """
        output = self.deepscale_moe(hidden_states, used_token)
        if self.use_residual:
            # Residual MoE
        ...
        return output, self.deepscale_moe.l_aux, self.deepscale_moe.exp_counts
