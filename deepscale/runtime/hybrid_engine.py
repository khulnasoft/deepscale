...
import torch
from deepscale.inference.config import DeepScaleInferenceConfig
from deepscale.module_inject.replace_policy import replace_policies
from deepscale.module_inject.utils import policy_to_ds_container
from .engine import DeepScaleEngine
from .utils import TLinear, get_inactive_params
from deepscale.runtime.zero import GatheredParameters
import time
import gc
import math
...
from deepscale.module_inject.layers import LinearLayer, Normalize, EmbeddingLayer, OPTEmbedding
...
class DeepScaleHybridEngine(DeepScaleEngine):
    r"""DeepScale engine for training and inference."""
            ...
            if self.mpu is None:
                ...
                for mp_group_id in range(num_mp_groups):
                    ...
                    if global_rank in ranks:
                        ...
                        from deepscale.module_inject import ReplaceWithTensorSlicing
