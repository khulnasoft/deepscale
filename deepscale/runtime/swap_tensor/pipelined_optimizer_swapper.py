...
from deepscale.runtime.swap_tensor.utils import (
    swap_in_tensors,
    swap_out_tensors,
    print_object,
    MIN_AIO_BYTES,
...
from deepscale.runtime.swap_tensor.async_swapper import AsyncTensorSwapper
from deepscale.runtime.swap_tensor.optimizer_utils import (
    SwapBufferManager,
    get_sized_buffer,
)
...
class PipelinedOptimizerSwapper(OptimizerSwapper):
    ...
    def swap_out_optimizer_state(self, parameter, async_swap):
        ...
        swap_op = self._swap_out_optimizer_state(
            aio_handle=self.write_aio_handle,
            parameter=parameter,
