...
from deepscale.runtime.swap_tensor.utils import SwapBufferManager, SwapBufferPool
...
class OptimizerSwapper(object):
    ...
    def swappable_tensor(self, param=None, numel=None):
        assert (
            param is not None or numel is not None
        ), "Either param or numel must be provided"
    ...
    def _swap_out_gradients(self,
        ...
        aligned_gradients, aligned_offsets = self._adjust_for_misaligned_lengths(
            tensors=gradient_tensors, offsets=gradient_offsets
        )
    ...
    def _initialize_from_swapped_fp16_params(
        self,
        aio_handle,
    ...
    def _initialize_parameters(self, parameters, src_tensors, aio_handle):
        ...
        self._swap_out_unpinned_tensors(
            aio_handle=aio_handle,
