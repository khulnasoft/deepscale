...
from deepscale.utils.timer import ThroughputTimer
from deepscale.accelerator import get_accelerator
from deepscale.runtime.bf16_optimizer import BF16_Optimizer

from ..engine import DeepScaleEngine, MEMORY_OPT_ALLREDUCE_SIZE
from deepscale.utils.timer import FORWARD_MICRO_TIMER, FORWARD_GLOBAL_TIMER, BACKWARD_MICRO_TIMER, \
...
class PipelineEngine(DeepScaleEngine):
    """ A training engine hybrid pipeline, data, and model parallel training.

    This engine is created by ``deepscale.initialize()`` when a :class:`PipelineModule`
    is provided.
    """
    ID_TO_DTYPE = [
    ...
    def _build_data_iter(self, dataset):
        ...
        pipe_dataloader = self.deepscale_io(dataset, data_sampler=sampler)
    ...
    def _exec_reduce_tied_grads(self):
        ...
        # `self.overlapping_partition_gradients_reduce_epilogue()` defined in the DeepScaleEngine
    ...
    def train_batch(self, data_iter=None):
        ...
        unless ``deepscale.initialize()`` was provided a training set. In that event,
        ...
        .. warning::
            ...
            DeepScale provides a convenience class :class:`deepscale.utils.RepeatingLoader`
    ...
    def is_gradient_accumulation_boundary(self):
        ...
        This is overridden from :class:`DeepScaleEngine` to force reductions
    ...
    def _exec_backward_pass(self, buffer_id):
        ...
        # The last stage just runs backward on the loss using DeepScale's typical
        # mechanisms.
        if self.is_last_stage():
    ...
    def module_state_dict(self, exclude_frozen_parameters=False):
        ...
        This method should only be called by DeepScale's ``save_checkpoint()``. The
