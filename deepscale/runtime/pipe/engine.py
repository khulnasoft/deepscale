...
from deepscale.utils.timer import SynchronizedWallClockTimer, ThroughputTimer

from deepscale.inference.engine import InferenceEngine
...
class PipelineEngine(DeepScaleEngine):
    ...
    def __init__(self, *super_args, **super_kwargs):
        ...
        assert (self.train_batch_size() == self.micro_batch_size * self.micro_batches *
