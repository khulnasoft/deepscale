...
from deepscale.checkpoint.utils import clone_tensors_for_torch_save


class PipelineError(Exception):
    """Errors related to the use of deepscale.PipelineModule """
...
class PipelineModule(nn.Module):
    ...
    Args:
        ...
        topology (``deepscale.runtime.pipe.ProcessTopology``, optional): Defines the axes of parallelism axes for training. Must be provided if ``num_stages`` is ``None``.
        ...
        activation_checkpoint_func (callable, optional): The function to use for activation checkpointing. Defaults to ``deepscale.checkpointing.checkpoint``.
