...
class PipelineParallelGrid:
    ...
    def __init__(self, topology=None, process_group=None):
        ...
        # Create new ProcessGroups for all model parallelism. DeepScaleLight uses these
        ...
        for dp in range(self.data_parallel_size):
            ...
            if self.global_rank == 0:
                #print(f'RANK={self.global_rank} building DeepScale model group: {ranks}')
                pass
    ...
    # MPU functions for DeepScale integration
    ...
    # Deepscale uses them to detect overflow, etc.
