...
from deepscale.runtime.data_pipeline.data_sampling.indexed_dataset import MMapIndexedDataset, valid_dtypes
from deepscale.runtime.data_pipeline.data_sampling.utils import split_dataset, split_index, create_mmap_dataset_builder, close_mmap_dataset_builder, find_fit_int_dtype
...
class DistributedDataAnalyzer(object):
    ...
    def __init__(
        ...
        if self.comm_group is None:
            # self.comm_group = deepscale.utils.groups._clone_world_group()
            self.num_workers = num_workers
            self.worker_id = worker_id
        else:
