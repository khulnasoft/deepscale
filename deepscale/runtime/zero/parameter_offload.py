...
from deepscale.utils import z3_leaf_module
from deepscale.runtime.utils import see_memory_usage
from deepscale.runtime.zero.utils import apply_to_tensors_only, is_zero_param
...
from deepscale.runtime.zero.partitioned_param_coordinator import PartitionedParameterCoordinator, InflightParamRegistry, iter_params
...
class DeepScaleZeRoOffload(object):
    ...
    def __init__(
        ...
        see_memory_usage("DeepScaleZeRoOffload initialize [begin]", force=True)
        ...
        see_memory_usage("DeepScaleZeRoOffload initialize [end]", force=True)
