...
from deepscale.ops.lion import DeepScaleCPULion, FusedLion
from deepscale.utils.nvtx import instrument_w_nvtx
...
ZERO_SUPPORTED_OPTIMIZERS = [
    torch.optim.Adam, torch.optim.AdamW, FusedAdam, DeepScaleCPUAdam, torch.optim.Adagrad, DeepScaleCPUAdagrad,
    DeepScaleCPULion, FusedLion
]
