...
class TiledLinear(torch.nn.Module):
    ...
    def copy_params_from(self, other):
        ...
        .. note::
            ...
            ranks. See :class:`deepscale.zero.GatheredParameters` for more
            information.
        ...
        for row in range(self.out_splits):
            ...
            for col in range(self.in_splits):
                ...
                with deepscale.zero.GatheredParameters(local.weight, modifier_rank=0):
                    local.weight.copy_(global_weight)

            if local.bias is not None:
                with deepscale.zero.GatheredParameters(local.bias, modifier_rank=0):
