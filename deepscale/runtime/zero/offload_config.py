...
from deepscale.runtime.config_utils import get_scalar_param
...
def get_offload_optimizer_config(param_dict):
    if OFFLOAD_OPTIMIZER in param_dict and param_dict[OFFLOAD_OPTIMIZER] is not None:
        ...
        offload_config[OFFLOAD_OPTIMIZER_PIPELINE] = (
            offload_config[OFFLOAD_OPTIMIZER_PIPELINE_READ]
            or offload_config[OFFLOAD_OPTIMIZER_PIPELINE_WRITE])
        return offload_config
