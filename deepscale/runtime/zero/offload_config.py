...
from deepscale.runtime.config_utils import DeepScaleConfigModel, pp_int
...
class DeepScaleZeroOffloadParamConfig(DeepScaleConfigModel):
...
class DeepScaleZeroOffloadOptimizerConfig(DeepScaleConfigModel):
