...
from deepscale.runtime.zero.utils import _initialize_parameter_parallel_groups
from deepscale.runtime.fp16.loss_scaler import LossScaler, DynamicLossScaler
from deepscale.runtime.utils import get_grad_norm, CheckOverflow
from deepscale.runtime.zero.config import ZERO_OPTIMIZATION_OPTIMIZER_STATES
...
class FP16_DeepScaleZeroOptimizer_Stage1(object):
    """
    FP16_DeepScaleZeroOptimizer_Stage1 designed to reduce the memory footprint
    ...
    def get_flat_sub_partitions(
        ...
        if (num_comm_intervals is not None
    ...
    def step(self, closure=None):
        ...
        if self.overflow:
            ...
            if self.verbose:
                logger.info(
                    "[deepscale] fp16 dynamic loss scale overflow! Skipping step. Attempted loss "
