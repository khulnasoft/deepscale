...
from deepscale.runtime.compression.cupy import CupyBackend
...
class MpiBackend(object):
    ...
    def compressed_allreduce(self,
        ...
        if self.cuda_aware:
            ...
            _, cupy_recvbuf_sign_server, _, cupy_recvbuf_scale_server = (
                self.allgather_host(
                    self.comm,
                    cupy_server_sign_packed[0],
                    cupy_recvbuf_sign_server,
