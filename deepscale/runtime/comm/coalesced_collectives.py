...
from deepscale.comm import ProcessGroup, all_to_all_single
from deepscale.accelerator import get_accelerator
from deepscale.utils import instrument_w_nvtx
from deepscale.ops import op_builder
...
def all_to_all_quant_reduce(tensors: List[Tensor], groups: {}) -> List[Tensor]:
    ...
    for idx, tensor in enumerate(tensors):
        if tensor.dim() == 1:
            ...
            # See more at https://github.com/khulnasoft/DeepScale/pull/5056
            logger.warning(
