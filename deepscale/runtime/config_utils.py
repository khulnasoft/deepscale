...
# DeepScale Team
"""
Collection of DeepScale configuration utilities
"""
import collections
import json
import torch
...
class DeepScaleConfigModel(BaseModel):
    """
    This class should be used as a base for all DeepScale configs. It extends
    ...
    Example:
        ...
        class MyExampleConfig(DeepScaleConfigModel):
            my_new_field: int = 0
...
class DeepScaleConfigObject(object):
    """
...
def dict_raise_error_on_duplicate_keys(ordered_pairs):
    ...
    if len(d) != len(ordered_pairs):
        ...
        raise ValueError("Duplicate keys in DeepScale config: {}".format(keys))
    return d
