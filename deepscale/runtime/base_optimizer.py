...
from deepscale.utils.tensor_fragment import map_to_flat_opt_states
from deepscale.runtime.utils import bwc_tensor_model_parallel_rank


class DeepScaleOptimizer(object):
    pass


class ZeROOptimizer(DeepScaleOptimizer):
