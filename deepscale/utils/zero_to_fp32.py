...
# This script extracts fp32 consolidated weights from a zero 2 and 3 DeepScale checkpoints. It gets
...
def get_fp32_state_dict_from_zero_checkpoint(checkpoint_dir, tag=None):
    ...
    In this example the ``model`` will no longer be useable in the deepscale context of the same
...
def load_state_dict_from_zero_checkpoint(model, checkpoint_dir, tag=None):
    ...
    Note, that once this was run, the ``model`` will no longer be useable in the deepscale context
