...
# DeepScale Team
"""
DeepScale launcher, this is similar to torch's distributed.launch but supports
additional features such as arbitrary gpu exclusion.

deepscale.launcher.launch is intended to be run on a single worker node and
...
def parse_args():
    parser = ArgumentParser(description="DeepScale distributed training launch"
...
def main():
    ...
    if args.save_pid:
        ...
        pid_file = os.path.join(PID_FILE_BASEPATH, f"{args.save_pid}.deepscale")
