...
from deepscale.launcher.constants import MPICH_LAUNCHER


def parse_args(args=None):
    parser = argparse.ArgumentParser(description="DeepScale launcher helper to map environment variables for"
