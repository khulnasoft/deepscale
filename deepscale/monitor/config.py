...
def get_monitor_config(param_dict):
    ...
    return DeepScaleMonitorConfig(**monitor_dict)


class TensorBoardConfig(DeepScaleConfigModel):
...
class WandbConfig(DeepScaleConfigModel):
    ...
    project: str = "deepscale"
    """ Name for the WandB project. """


class CSVConfig(DeepScaleConfigModel):
...
class CometConfig(DeepScaleConfigModel):
    """
...
class DeepScaleMonitorConfig(DeepScaleConfigModel):
