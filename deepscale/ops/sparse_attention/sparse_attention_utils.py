...
class SparseAttentionUtils:
    ...
    def replace_model_self_attention_with_sparse_self_attention(
        ...
        Return:
            model: updated model; in which self attention layer has been replaced with DeepScale Sparse Self Attention layer.
        """
    ...
    def replace_self_attention_layer_with_sparse_self_attention_layer(
        ...
        Return:
            layers: updated attention layers; in which self attention layers have been replaced with DeepScale Sparse Self Attention layer.
        """
