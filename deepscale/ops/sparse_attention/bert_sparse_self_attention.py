...
class BertSparseSelfAttention(nn.Module):
    """Implements Sparse Self Attention layer of Bert model based on https://github.com/khulnasoft/DeepScaleExamples/blob/master/bing_bert/nvidia/modelingpreln.py#L373
