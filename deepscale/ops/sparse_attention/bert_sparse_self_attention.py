...
from deepscale.ops.sparse_attention import SparseSelfAttention, FixedSparsityConfig


class BertSparseSelfAttention(nn.Module):
    """Implements Sparse Self Attention layer of Bert model based on https://github.com/khulnasoft-lab/DeepScaleExamples/blob/master/bing_bert/nvidia/modelingpreln.py#L373

    For more information please see, TODO DeepScale Sparse Transformer.

    For usage example please see, TODO DeepScale Sparse Transformer Tutorial.
    """
    def __init__(
        self,
        config,
