...
from deepscale.ops.op_builder import TransformerBuilder, StochasticTransformerBuilder
...
class DeepScaleTransformerLayer(nn.Module):
    ...
    def forward(self,
        ...
        return DeepScaleTransformerFunction.apply(hidden_states, attention_mask, self, grads, self.config.layer_id,
