...
from deepscale.utils.types import GATED_ACTIVATION_TYPES
...
class DeepScaleMLP(nn.Module):
    ...
    def __init__(self, config, mp_group=None, q_scales=None, q_groups=1, merge_count=1, mlp_extra_grouping=False):
        ...
        if len(DeepScaleMLP._inter_w_buffers) == 0:
            DeepScaleMLP._inter_w_buffers = [
    ...
    def _merge_inter_w(self):
        inter_w = DeepScaleMLP._inter_w_buffers[0]
        ...
        if self.inter_up_b is not None:
            inter_b = DeepScaleMLP._inter_w_buffers[1]
        ...
        return DeepScaleMLP._inter_w_buffers
