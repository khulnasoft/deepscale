...
from deepscale.ops.transformer.inference.op_binding import LinearOp, VectorMatMulOp, SoftmaxContextOp, QKVGemmOp
from deepscale.ops.transformer.inference.triton import (
    softmax,
    score_4d_matmul,
    context_4d_matmul,
)
...
class TritonSelfAttention(nn.Module):
    ...
    def _triton_autotune(min_seqlen,
                         ...
                         scale,
                         dtype=torch.float16):
        from deepscale.ops.transformer.inference.triton.matmul_ext import Fp16Matmul, score_4d_matmul, context_4d_matmul
        seqlen = [(min_seqlen + i)
