...
class DeepScaleSelfAttention(nn.Module):
    ...
    def __init__(self, config, mp_group=None, q_scales=None, q_groups=1, merge_count=1):
        ...
        self.config.layer_id = DeepScaleSelfAttention.num_layers
        DeepScaleSelfAttention.num_layers = DeepScaleSelfAttention.num_layers + 1
        ...
        if len(DeepScaleSelfAttention._qkv_buffers) == 0:
            DeepScaleSelfAttention._qkv_buffers = [
    ...
    def compute_attention(self, qkv_out, input_mask, layer_past, alibi, is_prompt, token_idx, position_ids):
        ...
        attn_key_value = self.score_context_func(
            ...
            num_layers=DeepScaleSelfAttention.num_layers,
            alibi=alibi,
            is_prompt=is_prompt,
            token_idx=token_idx,
    ...
    def _merge_qkv(self):
        qvkw = DeepScaleSelfAttention._qkv_buffers[0]
        ...
        if self.attn_qb is not None:
            qvkb = DeepScaleSelfAttention._qkv_buffers[1]
        ...
        return DeepScaleSelfAttention._qkv_buffers
...
class BloomSelfAttention(DeepScaleSelfAttention):
