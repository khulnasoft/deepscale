...
class DeepScaleCPULion(torch.optim.Optimizer):
    optimizer_id = 0
    ...
    def __init__(self, model_params, lr=1e-3, betas=(0.9, 0.999), weight_decay=0, fp32_optimizer_states=True):
        ...
        super(DeepScaleCPULion, self).__init__(model_params, default_args)
        ...
        self.opt_id = DeepScaleCPULion.optimizer_id
        DeepScaleCPULion.optimizer_id = DeepScaleCPULion.optimizer_id + 1
    ...
    def __setstate__(self, state):
        super(DeepScaleCPULion, self).__setstate__(state)
