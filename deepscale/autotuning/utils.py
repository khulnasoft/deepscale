...
import os
import json
from deepscale.runtime.constants import GRADIENT_ACCUMULATION_STEPS, TRAIN_MICRO_BATCH_SIZE_PER_GPU
import itertools
import copy
...
def validate_ds_config(config: dict):
    ...
    # HF requires that "ZeRO Offload can only work with DeepScale optimizers"
