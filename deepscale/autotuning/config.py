...
from deepscale.runtime.config_utils import get_scalar_param, get_dict_param, DeepScaleConfigObject
from deepscale.autotuning.constants import *


class DeepScaleAutotuningConfig(DeepScaleConfigObject):

    def __init__(self, param_dict):
        super(DeepScaleAutotuningConfig, self).__init__()
