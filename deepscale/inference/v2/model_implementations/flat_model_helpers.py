...
from deepscale.ops.op_builder import RaggedUtilsBuilder
...
class TensorMetadata(DeepScaleConfigModel):
    """
...
class ParameterMetadata(DeepScaleConfigModel):
    """
...
class LayerMetadata(DeepScaleConfigModel):
    """
...
class ModelMetadata(DeepScaleConfigModel):
    """
