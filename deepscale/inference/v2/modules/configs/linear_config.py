...
class DSLinearConfig(DSModuleConfig):
    ...
    """
    The activation function for this layer. See :class:`deepscale.inference.inference_utils.ActivationType` for
    supported activation functions.
    """

    input_dtype: DtypeEnum = DtypeEnum.fp16
    """
    The data type of the input tensor. See :class:`deepscale.inference.inference_utils.DtypeEnum` for supported
    data types.
    """

    output_dtype: DtypeEnum = DtypeEnum.fp16
    """
    The data type of the output tensor. See :class:`deepscale.inference.inference_utils.DtypeEnum` for supported
    data types.
    """
