...
if sys.platform == "win32":
    ...
    create_dir_symlink("..\\..\\csrc", ".\\deepscale\\ops\\csrc")
    create_dir_symlink("..\\..\\op_builder", ".\\deepscale\\ops\\op_builder")
...
setup(
    ...
    author_email="deepscale@khulnasoft.com",
    url="http://deepscale.khulnasoft.com",
