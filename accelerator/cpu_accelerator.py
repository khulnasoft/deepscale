...
class CPU_Accelerator(DeepScaleAccelerator):
    ...
    def device_count(self):
        ...
        if device_count > 0:
            ...
            from deepscale.utils.numa import get_numa_cores
    ...
    def stream(self, stream):
        from deepscale.runtime.utils import noop_context
        return noop_context()
    ...
    def op_builder_dir(self):
        try:
            ...
            from op_builder import __deepscale__  # noqa: F401 # type: ignore
            return "op_builder.cpu"
        except ImportError:
            return "deepscale.ops.op_builder.cpu"
    ...
    def get_op_builder(self, class_name):
        try:
            ...
            from deepscale.ops.op_builder.cpu import AsyncIOBuilder, CCLCommBuilder, ShareMemCommBuilder, FusedAdamBuilder, CPUAdamBuilder, NotImplementedBuilder
