...
class HPU_Accelerator(DeepScaleAccelerator):
    ...
    def op_builder_dir(self):
        try:
            ...
            return "deepscale.ops.op_builder.hpu"
    ...
    def visible_devices_envs(self):
        # Current way deepscale set this env var is not applicable with all HPU instances
