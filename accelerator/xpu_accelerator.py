...
import torch
from deepscale.accelerator.abstract_accelerator import DeepScaleAccelerator
...
class XPU_Accelerator(DeepScaleAccelerator):
    ...
    def pin_memory(self, tensor, align_bytes=1):
        if align_bytes == 1:
            ...
            from deepscale.ops.op_builder.xpu import AsyncIOBuilder
    ...
    def op_builder_dir(self):
        try:
            ...
            return "deepscale.ops.op_builder.xpu"
