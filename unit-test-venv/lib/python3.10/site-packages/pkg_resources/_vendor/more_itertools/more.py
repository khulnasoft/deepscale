...
def one(iterable, too_short=None, too_long=None):
    ...
    try:
        ...
        msg = ('Expected exactly one item in iterable, but got {!r}, {!r}, '
               'and perhaps more.'.format(first_value,
                                          second_value))
...
def interleave_evenly(iterables, lengths=None):
    ...
    if lengths is None:
        try:
            ...
            raise ValueError('Iterable lengths could not be determined automatically. '
    ...
    def walk(node, level):
        if (((levels is not None) and (level > levels))
                or isinstance(node,
                              (str,
                               bytes))
                or ((base_type is not None) and isinstance(node,
                                                           base_type))):
            yield node
            return
...
class numeric_range(abc.Sequence, abc.Hashable):
    ...
    def __getitem__(self, key):
        if isinstance(key, int):
            ...
            raise TypeError('numeric range indices must be '
...
class callback_iter:
    ...
    * Provide *wait_seconds* to adjust how frequently the it is polled for
    ...
    def _reader(self):
        ...
        self._future = self._executor.submit(self._func,
...
def minmax(iterable_or_value, *others, key=None, default=_marker):
    ...
    try:
        ...
        if default is _marker:
            raise ValueError('`minmax()` argument is an empty iterable. '
                             'Provide a `default` value to suppress this error.') from e
        return default
