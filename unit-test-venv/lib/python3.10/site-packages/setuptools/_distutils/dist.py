...
"""
    ...
    def _parse_command_opts(self, parser, args):  # noqa: C901
        ...
        if not issubclass(cmd_class, Command):
            raise DistutilsClassError("command class %s must subclass Command" %
                                      cmd_class)

        # Also make sure that the command object provides a list of its
        # known options.
        if not (hasattr(cmd_class,
                        'user_options') and isinstance(cmd_class.user_options,
                                                       list)):
        ...
        if hasattr(cmd_class,
                   'help_options') and isinstance(cmd_class.help_options,
                                                  list):
                ...
                if hasattr(opts, parser.get_attr_name(help_option)):
                    ...
                    if callable(func):
                        ...
                        raise DistutilsClassError(
                            ...
                            "must be a callable object (function, etc.)" % (func,
                                                                            help_option))
