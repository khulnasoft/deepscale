    ...
    def find(
        ...
        return list(
            cls._find_iter(
                ...
                cls._build_filter(*cls.ALWAYS_EXCLUDE,
                                  *exclude),
...
class ConfigDiscovery:
    ...
    def _explicitly_specified(self, ignore_ext_modules: bool) -> bool:
        ...
        return (self.dist.packages is not None or self.dist.py_modules is not None
                or ext_modules or hasattr(self.dist,
                                          "configuration") and self.dist.configuration
    ...
    def _analyse_package_layout(self, ignore_ext_modules: bool) -> bool:
        ...
        return (self._analyse_explicit_layout() or self._analyse_src_layout()
    ...
    def _analyse_explicit_layout(self) -> bool:
        ...
        pkgs = chain_iter(
            _find_packages_within(pkg,
                                  os.path.join(root_dir,
                                               parent_dir)) for pkg,
            parent_dir in package_dir.items())
...
def find_parent_package(packages: List[str],
                        package_dir: Mapping[str,
                                             str],
                        root_dir: _Path) -> Optional[str]:
