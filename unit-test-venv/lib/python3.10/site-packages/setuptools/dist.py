...
def check_requirements(dist, attr, value):
    ...
    try:
        ...
        tmpl = ("{attr!r} must be a string or list of strings "
...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        _Distribution.__init__(
            self,
            {
                k: v
                for k,
                v in attrs.items() if k not in self._DISTUTILS_UNSUPPORTED_METADATA
            },
        )
    ...
    def _validate_metadata(self):
        ...
        provided = {
            key
            for key in vars(self.metadata) if getattr(self.metadata,
                                                      key,
                                                      None) is not None
        }
    ...
    def _validate_version(version):
        ...
        if version is not None:
            try:
                ...
                warnings.warn("The version specified (%r) is an invalid version, this "
    ...
    def _move_install_requirements_markers(self):
        ...
        self.extras_require = dict(
            ...
            (k,
             list(dict.fromkeys(str(r) for r in map(self._clean_req,
                                                    v)))) for k,
            v in self._tmp_extras_require.items())
    ...
    def _expand_patterns(patterns):
        ...
        ['setup.cfg', 'LICENSE']
        """
        return (path for pattern in patterns for path in sorted(iglob(pattern))
    ...
    def warn_dash_deprecation(self, opt, section):
        ...
        if '-' in opt:
            warnings.warn("Usage of dash-separated '%s' will not be supported in future "
    ...
    def make_option_lowercase(self, opt, section):
        ...
        warnings.warn("Usage of uppercase key '%s' in '%s' will be deprecated in future "
                      "versions. Please use lowercase '%s' instead" % (opt,
                                                                       section,
                                                                       lowercase_opt))
    ...
    def parse_config_files(self, filenames=None, ignore_option_errors=False):
        ...
        setupcfg.parse_configuration(self,
    ...
    def _exclude_misc(self, name, value):
        ...
        if not isinstance(value, sequence):
            raise DistutilsSetupError("%s: setting must be a list or tuple (%r)" %
                                      (name,
                                       value))
        try:
    ...
    def _exclude_packages(self, packages):
        if not isinstance(packages, sequence):
            raise DistutilsSetupError("packages: setting must be a list or tuple (%r)" %
                                      (packages,
                                       ))
