    ...
    def urlopen(self,
        ...
        try:
            ...
            def _is_ssl_error_message_from_http_proxy(ssl_error):
                ...
                return ("wrong version number" in message
            ...
            if (isinstance(e,
                           BaseSSLError) and self.proxy
                    and _is_ssl_error_message_from_http_proxy(e) and conn.proxy
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def __init__(self,
        ...
        HTTPConnectionPool.__init__(self,
                                    host,
                                    port,
                                    strict,
                                    timeout,
