...
class Color(NamedTuple):
    ...
    def parse(cls, color: str) -> "Color":
        ...
        if color_24:
            triplet = ColorTriplet(int(color_24[0:2],
                                       16),
                                   int(color_24[2:4],
                                       16),
                                   int(color_24[4:6],
    ...
    def downgrade(self, system: ColorSystem) -> "Color":
        ...
        if system == ColorSystem.EIGHT_BIT and self.system == ColorSystem.TRUECOLOR:
            ...
            color_number = (16 + 36 * round(six_red) + 6 * round(six_green) +
                            round(six_blue))
            return Color(self.name, ColorType.EIGHT_BIT, number=color_number)
...
def parse_rgb_hex(hex_color: str) -> ColorTriplet:
    ...
    color = ColorTriplet(int(hex_color[0:2],
                             16),
                         int(hex_color[2:4],
                             16),
                         int(hex_color[4:6],
...
def blend_rgb(color1: ColorTriplet,
              color2: ColorTriplet,
              cross_fade: float = 0.5) -> ColorTriplet:
