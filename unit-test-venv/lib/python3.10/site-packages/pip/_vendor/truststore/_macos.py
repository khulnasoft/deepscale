...
def _handle_osstatus(result: OSStatus, _: typing.Any, args: typing.Any) -> typing.Any:
    ...
    try:
        ...
        error_message_cfstring_c_void_p = ctypes.cast(error_message_cfstring,
                                                      ctypes.POINTER(ctypes.c_void_p))
        message = CoreFoundation.CFStringGetCStringPtr(error_message_cfstring_c_void_p,
...
def _cf_string_ref_to_str(
        cf_string_ref: CFStringRef) -> str | None:  # type: ignore[valid-type]
    """
    ...
    string = CoreFoundation.CFStringGetCStringPtr(cf_string_ref,
                                                  CFConst.kCFStringEncodingUTF8)
    if string is None:
        buffer = ctypes.create_string_buffer(1024)
        result = CoreFoundation.CFStringGetCString(cf_string_ref,
                                                   buffer,
                                                   1024,
                                                   CFConst.kCFStringEncodingUTF8)
        if not result:
...
def _der_certs_to_cf_cert_array(
        certs: list[bytes]) -> CFMutableArrayRef:  # type: ignore[valid-type]
    ...
    try:
        ...
        if not is_trusted:
            ...
            if ssl_context.verify_mode != ssl.CERT_REQUIRED and (
                ...
                is_trusted = True
            elif (not ssl_context.check_hostname
        ...
        if not is_trusted:
            ...
            try:
                ...
                Security.SecTrustGetTrustResult(trust,
