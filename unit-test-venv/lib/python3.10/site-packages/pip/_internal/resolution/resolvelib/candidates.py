...
BaseCandidate = Union["AlreadyInstalledCandidate",
                      "EditableCandidate",
                      "LinkCandidate",
                      ]
...
def make_install_req_from_link(link: Link,
...
def make_install_req_from_editable(link: Link,
                                   template: InstallRequirement) -> InstallRequirement:
...
def _make_install_req_from_dist(dist: BaseDistribution,
                                template: InstallRequirement) -> InstallRequirement:
    if template.req:
        line = str(template.req)
    elif template.link:
...
class EditableCandidate(_InstallRequirementBackedCandidate):
    ...
    def __init__(
        ...
        super().__init__(
            link=link,
            source_link=link,
            ireq=make_install_req_from_editable(link,
                                                template),
            factory=factory,
            name=name,
            version=version,
