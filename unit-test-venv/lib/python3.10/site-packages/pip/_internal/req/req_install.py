...
class InstallRequirement:
    ...
    def isolated_editable_sanity_check(self) -> None:
        ...
        """
        if (self.editable and self.use_pep517 and not self.supports_pyproject_editable
...
def check_invalid_constraint_type(req: InstallRequirement) -> str:
    ...
    if problem:
        deprecated(
            reason=("Constraints are only allowed to take the form of a package "
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        ...
        logger.warning("Implying --no-binary=:all: due to the presence of "
