...
DeepScale-Ulysses partitions individual samples along the sequence
...
*Figure 1: DeepScale sequence parallelism (DeepScale-Ulysses) design*
</div>
...
## Release: Try DeepScale-Ulysses Today
