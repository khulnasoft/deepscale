...
# DeepScale Universal Checkpointing: Efficient and Flexible Checkpointing for Large Scale Distributed Training

</div>

<img src="./media/image1.png" style="width:6.5in;height:3.65625in" />

To cite DeepScale Universal Checkpoint, please cite our [arxiv report](https://arxiv.org/abs/2406.18820):
...
In this release, we are excited to introduce DeepScale Universal
...
The key insight of DeepScale *UCP* is the selection of the optimal
...
# General Availability of DeepScale Universal Checkpoint

We are excited to release DeepScale Universal Checkpoint. DeepScale
Universal Checkpoint is available in DeepScale versions >=
[0.14.4](https://github.com/khulnasoft/DeepScale/releases/tag/v0.14.4),
...
[DeepScale tutorial page](https://www.deepscale.ai/tutorials/universal-checkpointing/).

We welcome contributions and collaboration from the broader open-source
community. DeepScale Universal Checkpoint is part of the bigger
DeepScale ecosystem of large-scale AI training and inference. For more
details on all DeepScale technologies and innovations, please visit our
[website]((https://www.deepscale.ai/)) and follow us
on X, formerly Twitter, ([English](https://twitter.com/MSFTDeepScale),
[Japanese](https://twitter.com/MSFTDeepScaleJP))
and [Chinese Zhihu](https://www.zhihu.com/people/deepscale).
