...
*NOTE: All the benchmarks in this blog use the recommended DeepScale-FastGen persistent deployment mode.*
...
See [PR-4664](https://github.com/khulnasoft/DeepScale/pull/4664) for more details.
