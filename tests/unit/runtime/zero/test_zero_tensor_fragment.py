...
from deepscale.utils import safe_set_full_fp32_param, safe_set_full_grad, safe_set_full_optimizer_state
from deepscale.utils import safe_get_local_fp32_param, safe_get_local_grad, safe_get_local_optimizer_state
from deepscale.utils import safe_set_local_fp32_param, safe_set_local_grad, safe_set_local_optimizer_state
...
class TestTensorFragmentGet(DistributedTest):
    ...
    def test_zero_fragments(self, tmpdir, api_type, zero_stage, offload_device, frozen_weights):
        if offload_device == OffloadDeviceEnum.nvme:
            ...
            if not deepscale.ops.__compatible_ops__[AsyncIOBuilder.NAME]:
