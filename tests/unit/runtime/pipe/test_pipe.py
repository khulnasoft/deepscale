...
from unit.util import skip_on_arch, no_child_process_in_deepscale_io
...
class TestPipeDynamicShape(DistributedTest):
    ...
    def test_pipe_base(self, topo_config):
        ...
        with no_child_process_in_deepscale_io():
            engine, _, _, _ = deepscale.initialize(config=config_dict,
                                                   model=model,
