...
class TestDistInit(DistributedTest):
    ...
    def test_already_init(self, dist_init_required):
        ...
        deepscale.init_distributed(get_accelerator().communication_backend_name(),
...
class TestDistInitNoEnv(DistributedTest):
    ...
    def test(self):
        ...
        deepscale.init_distributed(get_accelerator().communication_backend_name(), auto_mpi_discovery=True)
...
class TestDistInitWithModel(DistributedTest):
    ...
    def test_already_init(self, dist_init_required):
        ...
        engine, *_ = deepscale.initialize(model=model,
                                          config=config_dict,
