...
from deepscale.launcher import runner as dsrun
from deepscale.autotuning.autotuner import Autotuner
from deepscale.autotuning.scheduler import ResourceManager
...
def test_autotuner_resources(tmpdir, active_resources):
    ...
    args = dsrun.parse_args(args=f'--autotuning {TUNE_OPTION} foo.py --deepscale_config {config_path}'.split())
