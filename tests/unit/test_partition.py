...
from deepscale.runtime.utils import partition_uniform
from deepscale.runtime.utils import partition_balanced
from deepscale.runtime.utils import prefix_sum_inc
from deepscale.runtime.utils import PartitionedTensor
...
def test_float_balanced():
    weights = [0.0, 1.1, 1.9, 3.0, 3.0, 3.0]
    P = 4
    parts = partition_balanced(weights, P)
    assert_valid_partition(weights, parts, P)
    assert parts == [0, 3, 4, 5, 6]
