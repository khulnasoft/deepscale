...
from simple_model import args_from_dict, create_deepscale_args
from megatron_model import get_gpt2_model, get_megatron_version, GPT2ModelPipe
from deepscale.utils import RepeatingLoader
...
class TestConfigurableMP:
    ...
    def get_deepscale_model(self, model, tmpdir):
        ds_config_dict = {
        ...
        model, _, _, _ = deepscale.initialize(
            args=ds_args, model=model, mpu=mpu, model_parameters=model.parameters()
        )
        return model
    ...
    def test_gpt2_basic(self, tmpdir):
        ...
        def _run():
            ...
            model = self.get_deepscale_model(model, tmpdir)
...
class TestConfigurablePP:
    ...
    def get_topology(self, mp, pp, world_size):
        ...
        from deepscale.runtime.pipe.topology import PipeModelDataParallelTopology
    ...
    def test_pp_basic(self, tmpdir):
        ...
        def _run():
            ...
            model = self.get_deepscale_model(gpt2_pipe_model, tmpdir)
