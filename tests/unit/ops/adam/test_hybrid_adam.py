...
from deepscale.ops.adam import FusedAdam, DeepScaleCPUAdam
from deepscale.ops.op_builder import CPUAdamBuilder, FusedAdamBuilder
from unit.common import DistributedTest

if not deepscale.ops.__compatible_ops__[CPUAdamBuilder.NAME]:
...
class TestHybridAdam(DistributedTest):
    ...
    def test_hybrid_adam_equal(self, dtype, model_size):
        ...
        ref_optimizer = DeepScaleCPUAdam([ref_param])
        ...
        cpu_optimizer = DeepScaleCPUAdam([cpu_param])
