...
import torch
import deepscale
from deepscale.ops.op_builder import SpatialInferenceBuilder
from deepscale.ops.transformer.inference.bias_add import nhwc_bias_add
from deepscale.accelerator import get_accelerator

if not deepscale.ops.__compatible_ops__[SpatialInferenceBuilder.NAME]:
