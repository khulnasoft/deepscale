...
from deepscale.linear import LoRAConfig, init_lora
...
class TestEngine(DistributedTest):
    ...
    def test_model(self):
        ...
        with deepscale.linear.Init(lora_config=lora_config, quant_config=quant_config):
        ...
        model, *_ = deepscale.initialize(config=ds_config, model=model, model_parameters=model.parameters())
