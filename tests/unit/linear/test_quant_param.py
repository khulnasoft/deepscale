...
from deepscale.linear.quantization import QuantizedParameter
from deepscale.linear.config import QuantizationConfig

from deepscale.ops.op_builder import FPQuantizerBuilder

from unit.common import DistributedTest

if not deepscale.ops.__compatible_ops__[FPQuantizerBuilder.NAME]:
