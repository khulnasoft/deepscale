...
# from deepscale_cuda import DeepScaleSoftmaxConfig, DeepScaleSoftmax
...
class BertSelfAttention(nn.Module):
    def __init__(self, i, config, weights, biases):
        ...
        # self.softmax_config = DeepScaleSoftmaxConfig()
        ...
        # self.softmax = DeepScaleSoftmax(i, self.softmax_config)
