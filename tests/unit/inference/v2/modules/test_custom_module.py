...
from deepscale.inference.v2.modules.interfaces import DSPostNormRegistry
from deepscale.inference.v2.modules.configs import DSNormConfig
from deepscale.inference.v2.modules.implementations import cuda_post_ln
...
"""
Here, we explicitly register an LN implementation outside the core deepscale repo. This should
