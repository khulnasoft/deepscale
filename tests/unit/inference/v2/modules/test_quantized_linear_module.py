...
from deepscale.inference.v2.inference_utils import ActivationType, DtypeEnum, is_gated
from deepscale.inference.v2.modules import ConfigBundle
from deepscale.inference.v2.modules.configs import DSLinearConfig
from deepscale.inference.v2.modules.interfaces import DSLinearRegistry
...
def _fp6_quant_dequant_weights(weight: torch.Tensor) -> torch.Tensor:
    from deepscale.inference.v2.modules.implementations.linear.quantized_linear import fp_quantize
...
def _fp6_quantized_linear_helper(tokens: int,
    ...
    if expect_failure:
        ...
        # Check DeepScale implementation
