...
def test_ext_param_getattr():
    ...
    engine, optim, _, _ = deepscale.initialize(
...
# fixed by https://github.com/khulnasoft/DeepScale/pull/1202
...
def test_subclass_param_init():
    ...
    with deepscale.zero.GatheredParameters(list(model.parameters(recurse=False))):
