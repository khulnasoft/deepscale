...
adam_configs = [["AdamW", False, False, False, (FusedAdam, True)],
                ...
                ["AdamW", True,  False, False, (DeepScaleCPUAdam, True)],
                ...
                ["AdamW", True,  False, True,  (DeepScaleCPUAdam, True)],
                ...
                ["Adam",  True,  False, False, (DeepScaleCPUAdam, False)],
                ...
                ["Adam",  True,  False, True,  (DeepScaleCPUAdam, True)],
...
def test_adam_configs(tmpdir,
    ...
    def helper(args):
        ...
        model, _, _, _ = deepscale.initialize(args=args,
                                              model=model,
