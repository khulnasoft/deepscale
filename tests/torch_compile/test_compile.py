...
parser.add_argument('--deepscale_config',
                    type=str,
                    default='ds_config_z3.json',
                    help='path to DeepScale configuration file')
cmd_args = parser.parse_args()

# initialize the DeepScale engine
model_engine, optimizer, _, _ = deepscale.initialize(args=cmd_args, model=model, model_parameters=params)
