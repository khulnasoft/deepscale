...
base_dir = "../../../DeepScaleExamples/BingBertSquad"

script_file_name = "run_squad_deepscale.sh"
...
def test_e2e_squad_deepscale_base(tmpdir):
...
def test_e2e_squad_deepscale_zero(tmpdir):
