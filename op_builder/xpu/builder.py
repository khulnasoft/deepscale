...
class SYCLOpBuilder(OpBuilder):
    ...
    def version_dependent_macros(self):
        try:
            ...
            from deepscale.ops.op_builder.builder import TORCH_MAJOR, TORCH_MINOR
    ...
    def load(self, verbose=True):
        from deepscale.git_version_info import installed_ops, torch_info, accelerator_name  # noqa: F401
    ...
    def jit_load(self, verbose=True):
        ...
        extra_include_paths = [self.deepscale_src_path(path) for path in self.include_paths()]
