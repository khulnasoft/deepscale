...
class AsyncIOBuilder(OpBuilder):
    ...
    def sources(self):
        return [
            'csrc/aio/py_lib/deepscale_py_copy.cpp',
            'csrc/aio/py_lib/py_ds_aio.cpp',
            'csrc/aio/py_lib/deepscale_py_aio.cpp',
            'csrc/aio/py_lib/deepscale_py_aio_handle.cpp',
            'csrc/aio/py_lib/deepscale_aio_thread.cpp',
            'csrc/aio/common/deepscale_aio_utils.cpp',
            'csrc/aio/common/deepscale_aio_common.cpp',
            'csrc/aio/common/deepscale_aio_types.cpp',
            'csrc/aio/py_lib/deepscale_pin_tensor.cpp',
            'csrc/aio/py_lib/deepscale_py_io_handle.cpp',
            'csrc/aio/py_lib/deepscale_cpu_op.cpp',
            'csrc/aio/py_lib/deepscale_aio_op_desc.cpp',
        ]
