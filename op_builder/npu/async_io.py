...
class AsyncIOBuilder(NPUOpBuilder):
    ...
    def absolute_name(self):
        return f'deepscale.ops.aio.{self.NAME}_op'

    def sources(self):
        return [
            'csrc/aio/py_lib/deepscale_py_copy.cpp', 'csrc/aio/py_lib/py_ds_aio.cpp',
            'csrc/aio/py_lib/deepscale_py_aio.cpp', 'csrc/aio/py_lib/deepscale_py_aio_handle.cpp',
            'csrc/aio/py_lib/deepscale_aio_thread.cpp', 'csrc/aio/common/deepscale_aio_utils.cpp',
            'csrc/aio/common/deepscale_aio_common.cpp', 'csrc/aio/common/deepscale_aio_types.cpp',
            'csrc/aio/py_lib/deepscale_pin_tensor.cpp'
        ]
    ...
    def cxx_args(self):
        ...
        import torch  # Keep this import here to avoid errors when building DeepScale wheel without torch installed
