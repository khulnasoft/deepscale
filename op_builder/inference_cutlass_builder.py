...
class InferenceCutlassBuilder(CUDAOpBuilder):
    ...
    def absolute_name(self):
        return f'deepscale.inference.v2.kernels.cutlass_ops.{self.NAME}'
    ...
    def get_prefix(self):
        ds_path = self.deepscale_src_path("deepscale")
        return "deepscale" if os.path.isdir(ds_path) else ".."
    ...
    def extra_ldflags(self):
        ...
        lib_path = self.deepscale_src_path(lib_path)

        args = [f'-L{lib_path}', '-ldeepscaleft']
        if self.jit_load:
