...
# Do not remove, required for abstract accelerator to detect if we have a deepscale or 3p op_builder
__deepscale__ = True

# List of all available op builders from deepscale op_builder
try:
    import deepscale.ops.op_builder  # noqa: F401 # type: ignore
    op_builder_dir = "deepscale.ops.op_builder"
except ImportError:
