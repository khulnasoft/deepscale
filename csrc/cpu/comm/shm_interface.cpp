...
at::Tensor& inference_all_reduce__functionalization_glue(at::Tensor& x)
{
    ...
    static auto op_handle = c10::Dispatcher::singleton()
                                ...
                                .findSchemaOrThrow("deepscale::inference_all_reduce", "")
