...
const int deepscale_aio_handle_t::get_block_size() const
{
    return _aio_ctxt ? _aio_ctxt->_block_size : -1;
}

const int deepscale_aio_handle_t::get_queue_depth() const
{
    return _aio_ctxt ? _aio_ctxt->_queue_depth : -1;
}

const bool deepscale_aio_handle_t::get_single_submit() const { return _single_submit; }

const bool deepscale_aio_handle_t::get_overlap_events() const { return _overlap_events; }

const int deepscale_aio_handle_t::get_thread_count() const { return _num_threads; }

int deepscale_aio_handle_t::read(torch::Tensor& buffer, const char* filename, const bool validate)
{
...
int deepscale_aio_handle_t::write(const torch::Tensor& buffer,
                                  const char* filename,
                                  const bool validate)
{
    assert(_aio_ctxt);
...
void deepscale_aio_handle_t::_schedule_aio_work(std::shared_ptr<struct io_op_desc_t> scheduled_op)
{
    for (auto& ctxt : _thread_contexts) {
        {
...
std::shared_ptr<struct io_op_desc_t> deepscale_aio_handle_t::_wait_for_aio_work()
{
...
void deepscale_aio_handle_t::_stop_threads()
{
...
int deepscale_aio_handle_t::wait()
{
...
bool deepscale_aio_handle_t::_is_valid_parallel_aio_op(const bool read_op,
...
int deepscale_aio_handle_t::pread(const torch::Tensor& buffer,
                                  const char* filename,
                                  const bool validate,
                                  const bool async)
{
...
int deepscale_aio_handle_t::pwrite(const torch::Tensor& buffer,
                                   const char* filename,
                                   const bool validate,
                                   const bool async)
{
...
int deepscale_aio_handle_t::sync_pread(torch::Tensor& buffer, const char* filename)
{
    return pread(buffer, filename, false, false);
}

int deepscale_aio_handle_t::sync_pwrite(const torch::Tensor& buffer, const char* filename)
{
    return pwrite(buffer, filename, false, false);
}

int deepscale_aio_handle_t::async_pread(torch::Tensor& buffer, const char* filename)
{
    return pread(buffer, filename, false, true);
}

int deepscale_aio_handle_t::async_pwrite(const torch::Tensor& buffer, const char* filename)
{
