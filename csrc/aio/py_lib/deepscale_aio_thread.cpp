...
deepscale_aio_thread_t::deepscale_aio_thread_t(const int tid, deepscale_aio_config_t& aio_config)
    : _tid(tid),
...
deepscale_aio_thread_t::~deepscale_aio_thread_t() {}

void deepscale_aio_thread_t::run()
{
    while (true) {
