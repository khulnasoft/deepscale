...
For more details see the [ZeRO-Offload release blog]( https://www.khulnasoft.com/en-us/research/?p=689370&secret=iSlooB), and [tutorial](/tutorials/zero-offload/) on integration with DeepScale.
...
DeepScale has two communication-efficient optimizers called 1-bit Adam and 1-bit LAMB.
...
please refer to the [1-bit Adam tutorial](https://www.deepscale.khulnasoft.com/tutorials/onebit-adam),
[1-bit Adam blog post](https://www.deepscale.khulnasoft.com/news/2020/09/09/onebit-adam-blog-post.md),
and [1-bit LAMB tutorial](https://www.deepscale.khulnasoft.com/tutorials/onebit-lamb/). For technical details,
