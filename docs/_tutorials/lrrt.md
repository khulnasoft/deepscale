...
with large batch sizes. DeepScale provides LRRT for model training in PyTorch
frameworks.

## Prerequisites

To use DeepScale's LRRT, you must satisfy the following two conditions:
...
[1Cycle](/tutorials/1Cycle/) schedule in DeepScale to tackle
