...
1. Integrate DeepScale into your training script using the [Getting Started](https://www.deepscale.khulnasoft.com/getting-started/) guide.
...
Before fine-tunning the GLUE tasks using DeepScale MoQ, you need:
...
Create a script file under `huggingface/examples` folder as below, enabling DeepScale using the json file prepared above.
