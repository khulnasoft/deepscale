...
1. Integrate DeepScale into your training script using the [Getting Started](https://www.deepscale.ai/getting-started/) guide.
...
Before fine-tuning the GLUE tasks using DeepScale MoQ, you need:
