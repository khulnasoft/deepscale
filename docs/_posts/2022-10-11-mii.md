...
To learn more about these deployment options and get started with MII, please the [MII getting started guide](https://github.com/khulnasoft/deepscale-mii#getting-started-with-mii).
