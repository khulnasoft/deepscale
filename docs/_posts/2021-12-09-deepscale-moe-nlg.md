---
title: "DeepScale-MoE for NLG: Reducing the training cost of language models by 5 times"
excerpt: ""
...
[DeepScale](http://deepscale.ai) on 128 A100 GPUs. DeepScale uses a
combination of data parallel and expert parallel training to effectively scale
the [MoE model training](https://www.microsoft.com/en-us/research/blog/deepscale-powers-8x-larger-moe-model-training-with-high-performance/).

We used the same training data as described in the [MT-NLG blog](https://www.microsoft.com/en-us/research/blog/using-deepscale-and-megatron-to-train-megatron-turing-nlg-530b-the-worlds-largest-and-most-powerful-generative-language-model/). For a fair
...
training time and training cost reduction by leveraging the efficient DeepScale
...
scripts](https://github.com/microsoft/Megatron-DeepSpeed/tree/moe-training/examples_deepscale/MoE)
