...
.. autofunction:: deepscale.runtime.zero.stage_1_and_2.estimate_zero2_model_states_mem_needs_all_live

.. autofunction:: deepscale.runtime.zero.stage_1_and_2.estimate_zero2_model_states_mem_needs_all_cold
...
.. code-block:: bash
    ...
    from deepscale.runtime.zero.stage_1_and_2 import estimate_zero2_model_states_mem_needs_all_live; \
...
.. code-block:: bash
    ...
    python -c 'from deepscale.runtime.zero.stage_1_and_2 import estimate_zero2_model_states_mem_needs_all_cold; \
...
.. autofunction:: deepscale.runtime.zero.stage3.estimate_zero3_model_states_mem_needs_all_live

.. autofunction:: deepscale.runtime.zero.stage3.estimate_zero3_model_states_mem_needs_all_cold
...
.. code-block:: bash
    ...
    python -c 'from transformers import AutoModel; \
    from deepscale.runtime.zero.stage3 import estimate_zero3_model_states_mem_needs_all_live; \
    model = AutoModel.from_pretrained("t5-3b"); \
...
.. code-block:: bash
    ...
    python -c 'from deepscale.runtime.zero.stage3 import estimate_zero3_model_states_mem_needs_all_cold; \
